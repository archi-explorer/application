  ...
  async sendEmail() {
    try {
      ...
      const response = await fetch(req, {
        ...
        body: `civilite=${encodeURIComponent(this._civilite)}
                &nom=${encodeURIComponent(this._nom)}
                &tel=${encodeURIComponent(this._tel)}
                &sujet=${encodeURIComponent(this._sujet)}
